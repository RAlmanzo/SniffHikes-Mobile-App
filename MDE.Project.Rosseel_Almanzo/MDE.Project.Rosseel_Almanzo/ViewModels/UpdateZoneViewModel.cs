...
{
    public class UpdateZoneViewModel : FreshBasePageModel
    {
        ...
        public UpdateZoneViewModel(IZonesService zonesService, IImageService imageService)
        {
        ...
        public ICommand DeleteZoneCommand
        {
            get
            {
                return new Command(async () =>
                {
                    var result = await _zonesService.DeleteZoneAsync(Id);
                    if (result == "Deleted")
                    {
                        await CoreMethods.DisplayAlert("Deleted", "Zone succesfull deleted!", "Ok");
                    }
                    else
                    {
        ...
        public ICommand UpdateZoneCommand
        {
            get
            {
                return new Command(async () =>
